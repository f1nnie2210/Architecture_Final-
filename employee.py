...
def login(Event=None):
    ...
    # ===== access in db - locate and validate emp_id/password=====
    with sqlite3.connect("./Database/store.db") as db:
        cur = db.cursor()
...
class Cart:
    ...
    def add_item(self, item):  # add function
        self.items.append(item)

    def remove_item(self):  # remove function
        self.items.pop()

    def remove_items(self):  # clear function
        self.items.clear()

    def total(self):  # total function
        total = 0.0
        for i in self.items:
            total += i.price * i.qty
        return total

    def isEmpty(self):  # if empty function
        if len(self.items) == 0:
            return True

    def allCart(self):  # allcart function
        for i in self.items:
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.button7.configure(activebackground="#41337A")
        self.button7.configure(cursor="hand2")
        self.button7.configure(foreground="#ffffff")
        self.button7.configure(background="#41337A")
        ...
        self.button8.configure(activebackground="#41337A")
        self.button8.configure(cursor="hand2")
        self.button8.configure(foreground="#ffffff")
        self.button8.configure(background="#41337A")
        ...
        self.button9.configure(activebackground="#41337A")
        self.button9.configure(cursor="hand2")
        self.button9.configure(foreground="#ffffff")
        self.button9.configure(background="#41337A")
        ...
        self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#41337A")
    ...
    # =====generate bill and insert in db=====
    def gen_bill(self):
