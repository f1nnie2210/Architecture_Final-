...
def valid_phone(phn):
    if re.match(r"(0|91)?[0-9]{9}", phn):
        return True
    return False


# =====validator identity number=====
def valid_identity(id):
    if id.isdigit() and len(id) == 12:
        return True
    return False


# =====validator password=====
def valid_password(pss):
    if re.fullmatch(r'[A-Za-z0-9@#$%^&+=]{8,}', pss):
        return True
    return False
...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(activebackground="#41337A")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#41337A")
...
# =====open aboutus window function=====
def about():
    messagebox.showinfo("Demo Info", "This page is not available yet - Dev by LongNguyen")
...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.message.configure(background="#5988D6")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#41337A")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#41337A")
        self.button2.configure(font="-family {Poppins SemiBold} -size 12")
        self.button2.configure(borderwidth="0")
        ...
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#41337A")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#ffffff")
        self.button3.configure(background="#41337A")
        self.button3.configure(font="-family {Poppins SemiBold} -size 12")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#41337A")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#41337A")
        self.button4.configure(font="-family {Poppins SemiBold} -size 12")
        self.button4.configure(borderwidth="0")
        ...
        self.button5.configure(relief="flat")
        self.button5.configure(overrelief="flat")
        self.button5.configure(activebackground="#41337A")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="#ffffff")
        self.button5.configure(background="#41337A")
        self.button5.configure(font="-family {Poppins SemiBold} -size 12")
        self.button5.configure(borderwidth="0")
        ...
        self.button6.configure(activebackground="#41337A")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="#ffffff")
        self.button6.configure(background="#41337A")
                                    ...
                                    try:
                                        ...
                                        if valid_phone(pvendor):
                                            ...
                                            with sqlite3.connect("./Database/store.db") as db:
                                                cur = db.cursor()
                                            update = (
                                                "UPDATE raw_inventory SET product_name = ?, product_cat = ?, "
                                                "product_subcat = ?, stock = ?, mrp = ?, cost_price = ?, vendor_phn = "
                                                "? WHERE product_id = ? "
                                            )
                                            cur.execute(update,
                                                        [pname, pcat, psubcat, int(pqty), float(pmrp), float(pcp),
...
class Employee:
    def __init__(self, top=None):
        ...
        self.tree.heading("Identity No.", text="Identity No.", anchor=W)
        ...
        if ename.strip():
            if valid_phone(econtact):
                if valid_identity(identity):
                    if edes:
                        if eadd:
                            if valid_password(epass):
                                emp_id = random_emp_id(7)
                                insert = (
                                    "INSERT INTO employee(emp_id, name, contact_num, address, identity_num, password, "
                                    "designation) VALUES(?,?,?,?,?,?,?) "
                                )
                                cur.execute(insert, [emp_id, ename, econtact, eadd, identity, epass, edes])
                                db.commit()
                                messagebox.showinfo("Success!!",
                                ...
                                messagebox.showerror("Oops!", "Invalid password.", parent=e_add)
                        else:
                    ...
                    messagebox.showerror("Oops!", "Invalid Identity number.", parent=e_add)
            else:
                    ...
                    if edes:
                        if eadd:
                            if valid_password(epass):
                                emp_id = vall[0]
                                update = (
                                    "UPDATE employee SET name = ?, contact_num = ?, address = ?, identity_num = ?, "
                                    "password = ?, designation = ? WHERE emp_id = ? "
                                )
                                cur.execute(update, [ename, econtact, eadd, identity, epass, edes, emp_id])
                                db.commit()
                                messagebox.showinfo("Success!!",
